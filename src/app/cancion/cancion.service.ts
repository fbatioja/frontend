...
export class CancionService {
  ...
  getAllCanciones(usuario: number, token: string): Observable<Cancion[]>{
    const headers = new HttpHeaders({
      'Authorization': `Bearer ${token}`
    })
    return this.http.get<Cancion[]>(`${this.backUrl}/usuario/${usuario}/allcanciones`, {headers: headers})
  }
  ...
  compartirCancion(cancionId: number, usuarios: Array<number>) {
    return this.http.post<any>(`${this.backUrl}/cancion/${cancionId}/compartir`, {"usuarios": usuarios})
  }
}
